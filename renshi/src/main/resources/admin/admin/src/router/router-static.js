...
import center from '@/views/center'
    ...
    import caiwubaoxiao from '@/views/modules/caiwubaoxiao/list'
    ...
    import dictionaryCaiwubaoxiao from '@/views/modules/dictionaryCaiwubaoxiao/list'
    import dictionaryCaiwubaoxiaoYesno from '@/views/modules/dictionaryCaiwubaoxiaoYesno/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryCaiwubaoxiao',
        name: '财务报销类型',
        component: dictionaryCaiwubaoxiao
    }
    ,{
        path: '/dictionaryCaiwubaoxiaoYesno',
        name: '财务报销状态',
        component: dictionaryCaiwubaoxiaoYesno
    }
    ,{
